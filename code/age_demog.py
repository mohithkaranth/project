...
order = ['0-18', '18-24', '25-34','35-44','45-49','56+']

col_names = ['userid', 'age_range_desc', 'gender', 'occupation_desc']
userdata = pd.read_sql(sql_text,engine,  columns=col_names)
plots = userdata.age_range_desc.value_counts().ix[order].plot(kind='bar', fontsize=8, colormap=cmap_bold)

fig = plots.get_figure()
fig.savefig('C:\\Users\\user\\project\\reports\\age_range_demog.jpg')
